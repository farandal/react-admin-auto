...
var attributeToInput = function (input) {
    ...
    switch (input.type) {
        ...
        case Date:
            return input.fieldOptions && input.fieldOptions.showTime ? (React.createElement(react_admin_date_inputs_1.DateTimeInput, { label: input.label, source: input.attribute, options: input.fieldOptions })) : (React.createElement(react_admin_1.DateInput, { label: input.label, source: input.attribute, options: input.fieldOptions }));
    }
