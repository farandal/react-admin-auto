...
exports.AutoList = function (props, _a) {
    var schema = _a.schema;
    return (React.createElement(react_admin_1.List, __assign({}, props, { filters: React.createElement(exports.AutoFilter, null), pagination: React.createElement(ExtendedPagination, null) }), exports.AutoDataGrid(props, { schema: schema })));
};
