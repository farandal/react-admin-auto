...
var attributeToField = function (input) {
    ...
    switch (input.type) {
        ...
        case Date:
            return React.createElement(react_admin_1.DateField, { label: input.label, source: input.attribute, options: input.fieldOptions });
    }
    if (input.extended) {
        return React.createElement(react_admin_1.LongTextField, { label: input.label, source: input.attribute, options: input.fieldOptions });
    }
