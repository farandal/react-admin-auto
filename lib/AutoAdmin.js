...
var attributeToField = function (input) {
    ...
    switch (input.type) {
        ...
        case Number:
            return React.createElement(react_admin_1.NumberField, { label: input.label, source: input.attribute });
        case Boolean:
            return React.createElement(react_admin_1.BooleanField, { label: input.label, source: input.attribute });
        case Date:
            return React.createElement(react_admin_1.DateField, { label: input.label, showTime: input.showTime, source: input.attribute });
    }
    return React.createElement(react_admin_1.TextField, { label: input.label, source: input.attribute });
};
var attributeToInput = function (input) {
    if (Array.isArray(input.type) && input.type.length > 0) {
        ...
        if (typeof inputType === 'string') {
            ...
            return (React.createElement(react_admin_1.ReferenceArrayInput, { label: input.label, reference: reference, source: input.attribute },
                React.createElement(react_admin_1.AutocompleteArrayInput, { optionText: sourceName })));
        }
        else {
            var inputTypeArray = input.type;
    ...
    switch (input.type) {
        ...
        case Date:
            return React.createElement(react_admin_1.DateInput, { label: input.label, showTime: input.showTime, source: input.attribute });
    }
