    ...
    if (Array.isArray(input.type) && input.type.length > 0) {
        ...
        if (typeof inputType === 'string') {
            ...
            return (React.createElement(react_admin_1.ArrayField, { source: input.attribute },
                React.createElement(react_admin_1.Datagrid, null, inputTypeArray.map(attribute => attributeToField(attribute)))));
        }
    }
    ...
    if (Array.isArray(input.type) && input.type.length > 0) {
        ...
        if (typeof inputType === 'string') {
            ...
            return (React.createElement(react_admin_1.ArrayInput, { source: input.attribute },
                React.createElement(react_admin_1.SimpleFormIterator, null, inputTypeArray.map(attribute => attributeToInput(attribute)))));
        }
    }
    if (typeof input.type === 'string') {
        const [reference, sourceName] = input.type.split('.');
