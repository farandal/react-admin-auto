...
var UserAction = function (_a) {
    ...
    if (typeof action === 'function' && action.prototype && action.prototype.render) {
        var Action = action;
        return React.createElement(Action, { id: record.id, record: record });
    }
...
exports.AutoFilterGenerator = function (referenceFilters) { return function (props) {
    ...
    return (React.createElement(react_admin_1.Filter, __assign({}, props),
        ...
        referenceFilters &&
            ...
            referenceFilters.map(function (r) { return (React.createElement(react_admin_1.ReferenceInput, { label: r.label, source: r.source, reference: r.reference, allowEmpty: true },
                React.createElement(react_admin_1.SelectInput, { optionText: r.optionText }))); })));
}; };
...
exports.AutoList = function (props, _a) {
    var schema = _a.schema, exporter = _a.exporter, referenceFilters = _a.referenceFilters;
    var CustomAutoFilter = exports.AutoFilterGenerator(referenceFilters);
    return (React.createElement(react_admin_1.List, __assign({}, props, { exporter: exporter, filters: React.createElement(CustomAutoFilter, null), pagination: React.createElement(ExtendedPagination, null) }), exports.AutoDataGrid(props, { schema: schema })));
};
exports.AutoResource = function (modelName, _a) {
    var schema = _a.schema, references = _a.references, exporter = _a.exporter, referenceFilters = _a.referenceFilters;
    var list = function (props) { return exports.AutoList(props, { schema: schema, exporter: exporter, referenceFilters: referenceFilters }); };
